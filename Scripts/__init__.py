...
set_provider_as_IBMQ('e3bed6f41718e889ae0c2df01f66d653f8d89b746cdaff50af04f8dd290e52ca642e8e96011131c8e21dee85bfb75a42fb3b944e9d075a3e213665d2c5929ab5')
...
def set_backend(backend: str = 'qasm_simulator'):
    ...
    global _backend
    global provider
    available_backends = provider.backends(filters=lambda x: x.status().operational == True)
    if backend != '' and backend in [b.name for b in available_backends]:
