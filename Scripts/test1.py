...
if __name__ == '__main__':
    # Create an instance of the TwoBitCircuit with specific parameters
    circuit_instance = TwoBitCircuit(code='a0b0', control=0, act=1)

    # Print the constructed circuit
    print(circuit_instance.circuit)
